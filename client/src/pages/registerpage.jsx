...
export default function registerpage(){
    ...
    return(
        <div className="mt-4 grow flex items-center justify-around">
            <div className="mb-64">
            <h1 className="text-4xl text-center mb-4">Register portal for Artist / Customer</h1>
            ...
            <input type="text" className="w-full border my-2 py-2 px-3 rounded-2xl"placeholder='username' value={name} onChange={ev=>setName(ev.target.value)}/>
                ...
                <input type="text" className="w-full border my-2 py-2 px-3 rounded-2xl"placeholder='Write your gov id (Only for artist Not required for Customers)' value={govno} onChange={ev=>setGovno(ev.target.value)}/>
