    ...
    <div>
      ...
      <form onSubmit={addNewProduct}>
        ...
        <input
          ...
          placeholder="title, for eg:Kashmir famous saffron"
        />
        ...
        <input
          ...
          placeholder="District Of The Product"
        />

        <h2 className="text-2xl mt-4">Photos</h2>
        <p className="text-gray-500 text-sm">
          Showcase Product(We Encourage Adding Bills And Invoice In Favour Of
          Authenticity.)
        </p>
        ...
        <textarea
          className="w-full border my-2 py-2 px-3 rounded-2xl"
          value={artistauth}
          onChange={(ev) => setArtistauth(ev.target.value)}
        />
        ...
        <p className="text-gray-500 text-sm">
          The rich cultural association of product
        </p>
        <textarea
          className="w-full border my-2 py-2 px-3 rounded-2xl"
          value={history}
        ...
        <div className="flex flex-col items-center my-6 justify-center">
          ...
          <textarea
            className="w-full border my-2 py-2 px-3 rounded-2xl"
            value={artistdes}
            onChange={(ev) => setArtistdes(ev.target.value)}
          />
        </div>
        <button className="bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-300 px-8 py-2  text-white rounded-full my-6">
          Save
        </button>
      </form>
    </div>
